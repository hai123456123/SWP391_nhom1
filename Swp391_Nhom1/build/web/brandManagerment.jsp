...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <script type="text/javascript">
        function doDelete(bid) {
            if (confirm("Bạn có chắc chắn muốn xóa nhãn hàng có bid =" + bid)) {
            ...
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-9">
                        ...
                        <h5 style="color: red">${requestScope.messaddbrand}</h5>
                        <a href="addBrand.jsp"><button class="btn btn-primary">Thêm Nhãn Hàng</button></a>
                    </div>
                </div>
                            ...
                            <div class="panel-body">
                                <div class="table-responsive">
                                    <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                        ...
                                        <tbody>
                                            <c:forEach items="${requestScope.listBrand}" var="lb">
                                                <tr>
                                                    <td>${lb.id}</td>
                                                    <td>${lb.name}</td>
                                                    <td>
                                                        ...
                                                        <button class="btn btn-danger btn-xs">
                                                            <a href="#" class="delete-link" onclick="doDelete('${lb.id}')">Delete</a>
                                                        </button>
                                                    </td>
                                                </tr>
                                            </c:forEach>
